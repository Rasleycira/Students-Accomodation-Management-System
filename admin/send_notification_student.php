...
while($row=mysqli_fetch_array($res))
{
	...
	<?php echo $row["username"]."(". $row["registration"].")"; ?>
		</option>
<?php	
}
?>
...
{
	mysqli_query($link,"insert into messages values('','$_SESSION[admin]','$_POST[dusername]','$_POST[title]','$_POST[msg]','n')")or die(mysqli_error($link));
?>
<script type="text/javascript">
